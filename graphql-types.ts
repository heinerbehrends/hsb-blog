...
export type CardsQuery = { allMdx: { nodes: Array<(
      Pick<Mdx, 'slug'>
      & { frontmatter?: Maybe<(
        Pick<MdxFrontmatter, 'description' | 'title' | 'alt' | 'url' | 'github'>
...
export type MetaQuery = { site?: Maybe<{ siteMetadata?: Maybe<(
...
export type FourOhFourQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };

export type BlogQueryVariables = Exact<{ [key: string]: never; }>;


export type BlogQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, allMdx: { nodes: Array<(
      Pick<Mdx, 'excerpt'>
...
export type HomeQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, allMdx: { nodes: Array<(
      Pick<Mdx, 'excerpt'>
      & { fields?: Maybe<Pick<MdxFields, 'slug'>>, frontmatter?: Maybe<Pick<MdxFrontmatter, 'date' | 'title' | 'description'>> }
    )> } };
...
export type PortfolioItemBySlugQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, mdx?: Maybe<(
    Pick<Mdx, 'id' | 'excerpt' | 'body'>
    & { frontmatter?: Maybe<(
      Pick<MdxFrontmatter, 'title' | 'date' | 'description' | 'alt' | 'url' | 'github'>
      & { image?: Maybe<{ childImageSharp?: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }> }
    )> }
  )>, previous?: Maybe<{ fields?: Maybe<Pick<MdxFields, 'slug'>>, frontmatter?: Maybe<Pick<MdxFrontmatter, 'title'>> }>, next?: Maybe<{ fields?: Maybe<Pick<MdxFields, 'slug'>>, frontmatter?: Maybe<Pick<MdxFrontmatter, 'title'>> }> };
