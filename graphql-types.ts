...
export type ImageFormat = "NO_" | "AUTO" | "JPG" | "PNG" | "WEBP" | "AVIF"
...
export type BlurredOptions = {
  ...
  width?: Maybe<Scalars["Int"]>
  /** Force the output format for the low-res preview. Default is to use the same format as the input. You should rarely need to  this */
  toFormat?: Maybe<ImageFormat>
}
...
export type StaticImageTimeArgs = {
  formatString?: Maybe<Scalars["String"]>
  fromNow?: Maybe<Scalars["Boolean"]>
  difference?: Maybe<Scalars["String"]>
  locale?: Maybe<Scalars["String"]>
